...
declare module "isomorphic-git/index.umd.min.js" {
  ...
  namespace CheckoutConflictError {
  ...
  namespace CommitNotFetchedError {
  ...
  namespace EmptyServerResponseError {
  ...
  namespace InvalidFilepathError {
  ...
  namespace MergeNotSupportedError {
  ...
  namespace MissingParameterError {
  ...
  namespace RemoteCapabilityError {
  ...
  namespace UnknownTransportError {
